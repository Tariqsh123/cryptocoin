            ...
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu shadow-sm m-0">
                        ...
                        <a href="token.html" class="dropdown-item">Plan</a>
        ...
        <div class="card-body p-4">
          ...
          <form action="login.php" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control" name="password" id="loginPassword" placeholder="Enter password" required>
            </div>
            <div class="d-grid">
        ...
        <div class="card-body p-4">
          ...
          <form action="register.php" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="name" id="regName" placeholder="Enter name" required>
            </div>
            <div class="mb-3">
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="">Plan</a>
                </div>
                <div class="col-lg-3 col-md-6">
